    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      ...
      <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav side-nav">
          ...
          <li class="active"><a href="<?php echo site_url('Manager/activity'); ?>"><i class="glyphicon glyphicon-picture"></i> ภาพกิจกรรม </a></li>
            ...
            <div class="panel panel-primary">
              ...
              <div class="panel-body">
                <div class="col-xs-6 col-md-6">
                  <a href="<?php echo site_url('Manager/activity_add') ?>">
                      ...
                      if( !empty($activity) ) {
                        ...
                        <tr>
                          ...
                          <td style="width:200px; vertical-align:middle; text-align:center;">
                            <a href="<?php echo site_url('Manager/activity_delete'); ?>/<?php echo $activity->activity_id; ?>" onclick="return confirm('ยืนยันการลบภาพกิจกรรมนี้ ?');">
