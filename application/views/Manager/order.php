    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      ...
      <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav side-nav">
          ...
          <li class="active"><a href="<?php echo site_url('Manager/order'); ?>"><i class="glyphicon glyphicon-list-alt"></i> รายการสั่งซื้อสินค้า </a></li>
            ...
            <div class="panel panel-primary">
              ...
              <div class="panel-body">
                ...
                <div class="col-xs-4 col-md-4">
                  <form id="contact_form" action="<?php echo site_url('Manager/order') ?>" method="post">
                      ...
                      if( !empty($product) ) {
                        ...
                        <tr>
                          ...
                          <td style="width:220px; vertical-align:middle; text-align:center;">
                            <a href="<?php echo site_url('Manager/product_order'); ?>/<?php echo $product->product_id ?>">
                              <input type="button" class="btn btn-info" name="btn_edit" value="สั่งซื้อสินค้า">
                            </a>

                            <?php if($product->product_order > 0){ ?>
                            <a href="<?php echo site_url('Manager/order_accept'); ?>/<?php echo $product->product_id ?>" onclick="return confirm('รับสินค้าแล้ว ?');">
