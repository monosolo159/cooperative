          ...
          <div class="col-lg-12">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class="glyphicon glyphicon-user"></i> ขายสินค้า </h3>
              </div>
              <div class="panel-body">
                <form id="contact_form" action="<?php echo site_url('officer/product_sell_add') ?>" data-toggle="validator" role="form" method="post" enctype="multipart/form-data">
                  <div class="col-xs-6 col-md-6" style="margin-top:20px;">

                    <div class="form-group">
                      <label for="name_product">ชื่อสินค้า : </label>
                      <input type="text" class="form-control" data-error="กรุณาระบุชื่อสินค้าให้ถูกต้อง" value="<?php echo $product[0]['product_name'] ?>" disabled>
                      <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group">
                      <label for="name_product">รหัสสมาชิก : <span style="color:red; font-size:20px;">*</span> </label>
                      <input type="text" class="form-control" name="member_id" id="member_id" data-error="กรุณาระบุรหัสสมาชิก" required>
                      <div class="help-block with-errors"></div>
                    </div>
                    <!-- <div class="form-group">
                  ...
                  <div class="col-xs-6 col-md-6" style="margin-top:20px;">
                    <div class="form-group">
                      <label for="balance_product"> ราคา :  </label>
                      <input type="number" class="form-control" maxlength="13" value="<?php echo $product[0]['product_price'] ?>" disabled>
                      <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group">
                      <label for="balance_product"> จำนวน : <span style="color:red; font-size:20px;">*</span> </label>
                      <input type="number" class="form-control" name="product_qty" id="product_qty" maxlength="13" data-error="กรุณาระบุจำนวนให้ถูกต้อง" required>
                      <div class="help-block with-errors"></div>
                    </div>
                    <input type="hidden" name="product_id" value="<?php echo $product[0]['product_id'] ?>">
                    <input type="hidden" name="authorities_id" value="<?php echo $this->session->userdata['authorities_id'] ?>">
                    <input type="hidden" name="product_sell_price" value="<?php echo $product[0]['product_price'] ?>">
                    <!-- <div class="form-group">
