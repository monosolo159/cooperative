            ...
            <div class="panel panel-primary">
              ...
              <div class="panel-body">
                <div class="col-xs-6 col-md-6">
                  <a href="<?php echo site_url('officer/member_add') ?>">
                    <input type="button" class="btn btn-info" name="btn_Add" value="เพิ่มสมาชิก">
                  </a>
                </div>
                <div class="col-xs-2 col-md-2"></div>
                <div class="col-xs-4 col-md-4">
                  <form id="contact_form" action="<?php echo site_url('officer/member') ?>" method="post">
                      ...
                      if( !empty($member) ) {
                        ...
                        <tr>
                          ...
                          <td style="width:130px; vertical-align:middle;">
                            ...
                            <a href="<?php echo site_url('officer/member_delete'); ?>/<?php echo $member->member_id; ?>" onclick="return confirm('ยืนยันการลบข้อมูลสมาชิกท่านนี้ ?');">
