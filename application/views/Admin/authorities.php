          ...
          <div class="col-lg-12">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class="glyphicon glyphicon-user"></i> เจ้าหน้าที่ </h3>
              </div>
              <div class="panel-body">
                <div class="col-xs-6 col-md-6">
                  <a href="<?php echo site_url('admin/authorities_add') ?>">
                    <input type="button" class="btn btn-info" name="btn_Add" value="เพิ่มเจ้าหน้าที่">
                  </a>
                </div>
                <div class="col-xs-2 col-md-2"></div>
                <div class="col-xs-4 col-md-4">
                  <form id="contact_form" action="<?php echo site_url('admin/authorities') ?>" method="post">
                    <div class="input-group">
                      <input type="text" class="form-control" name="authorities_search" placeholder="ป้อนชื่อเจ้าหน้าที่">
                      ...
                      <?php if( !empty($authorities) ) {
                        ...
                        <tr>
                          ...
                          <td style="width:100px;">
                            <img src="<?php echo base_url('image/authorities/'); ?>/<?php echo $authorities->authorities_image ?>" width="100px">
                          </td>
                          <td style="text-align:center; vertical-align:middle;"> <?php echo $authorities->authorities_name ?> <?php echo $authorities->authorities_surname ?> </td>
                          <td style="text-align:center; vertical-align:middle;"> <?php echo $authorities->authorities_email ?> </td>
                          <td style="text-align:center; vertical-align:middle;"> <?php echo $authorities->authorities_tel ?> </td>
                          <td style="width:130px; vertical-align:middle;">
                            <a href="<?php echo site_url('admin/authorities_edit'); ?>/<?php echo $authorities->authorities_id ?>">
                              <input type="button" class="btn btn-warning" name="btn_edit" value="แก้ไข">
                            </a>
                            <a href="<?php echo site_url('admin/authorities_delete'); ?>/<?php echo $authorities->authorities_id ?>" onclick="return confirm('ยืนยันการลบข้อมูลเจ้าหน้าที่ท่านนี้ ?');">
