          ...
          <div class="col-lg-12">
            <div class="panel panel-primary">
              ...
              <div class="panel-body">
                <form id="contact_form" action="<?php echo site_url('admin/authorities_editdata') ?>" data-toggle="validator" role="form" method="post" enctype="multipart/form-data">
                  <div class="col-xs-6 col-md-6" style="margin-top:20px;">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="name_authorities" id="name_authorities" data-error="กรุณาระบุชื่อให้ถูกต้อง" required value="<?php echo $authorities[0]['authorities_name'] ?>">
                      <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group">
                      <label for="surname_authorities"> นามสกุล : <span style="color:red; font-size:20px;">*</span> </label>
                      <input type="text" class="form-control" name="surname_authorities" id="surname_authorities" data-error="กรุณาระบนามสกุลให้ถูกต้อง" required value="<?php echo $authorities[0]['authorities_surname'] ?>">
                      <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group">
                      ...
                      <select class="form-control" name="gender_authorities" id="gender_authorities" data-error="กรุณาระบุเพศให้ถูกต้อง" required>
                        <option></option>
                        <option <?php if ($authorities[0]['authorities_gender'] == 'ผู้หญิง') { echo "selected"; } ?> value="ผู้หญิง">ผู้หญิง</option>
                        <option <?php if ($authorities[0]['authorities_gender'] == 'ผู้ชาย') { echo "selected"; } ?> value="ผู้ชาย">ผู้ชาย</option>
                      </select>
                      <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group">
                      <label for="birthday_authorities">วันเกิด : <span style="color:red; font-size:20px;">*</span> </label>
                      <input type="date" class="form-control" name="birthday_authorities" id="birthday_authorities" data-error="กรุณาระบุวันเกิดให้ถูกต้อง" required value="<?php echo $authorities[0]['authorities_birthday'] ?>">
                      <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group">
                      <label for="tel_authorities">เบอร์โทร : <span style="color:red; font-size:20px;">*</span> </label>
                      <input type="text" class="form-control" name="tel_authorities" id="tel_authorities" data-error="กรุณาระบุเบอร์โทรให้ถูกต้อง" required maxlength="10" value="<?php echo $authorities[0]['authorities_tel'] ?>">
                      <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group">
                      <label for="address_authorities">ที่อยู่ : <span style="color:red; font-size:20px;">*</span> </label>
                      <textarea class="form-control" name="address_authorities" id="address_authorities" rows="5" data-error="กรุณาระบุที่อยู่ให้ถูกต้อง" required><?php echo $authorities[0]['authorities_address'] ?></textarea>
                      <div class="help-block with-errors"></div>
                    </div>
                  ...
                  <div class="col-xs-6 col-md-6" style="margin-top:20px;">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="idcard_authorities" id="idcard_authorities" maxlength="13" data-error="กรุณาระบุเลขบัตรประจำตัวประชาชนให้ถูกต้อง" required value="<?php echo $authorities[0]['authorities_idcard'] ?>">
                      <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group">
                      <label for="email_authorities">อีเมล : <span style="color:red; font-size:20px;">*</span> </label>
                      <input type="email" class="form-control" name="email_authorities" id="email_authorities" data-error="กรุณาระบุอีเมลให้ถูกต้อง" required value="<?php echo $authorities[0]['authorities_email'] ?>">
                      <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group">
                      <label for="user_authorities">ชื่อผู้ใช้งาน : <span style="color:red; font-size:20px;">*</span> </label>
                      <input type="text" class="form-control" name="user_authorities" id="user_authorities" data-error="กรุณาระบุชื่อผู้ใช้งานให้ถูกต้อง" required value="<?php echo $authorities[0]['authorities_user'] ?>">
                      <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group">
                      <label for="password_authorities">รหัสผ่าน : <span style="color:red; font-size:20px;"> &nbsp;</span> </label>
                      <input type="password" class="form-control" name="password_authorities" id="password_authorities">
                      <input type="hidden" class="form-control" name="id_authorities" id="id_authorities" value="<?php echo $authorities[0]['authorities_id'] ?>">
                    </div>
                    <div class="form-group">
                      <label for="file_authorities">อัปโหลดรูปภาพ : <span style="color:red; font-size:20px;"> &nbsp;</span> </label>
                      <input type="file" class="form-control" name="file_authorities" id="file_authorities" data-error="กรุณาเลือกรูปภาพให้ถูกต้อง">
                      <div class="help-block with-errors"></div>
                    </div>
