          ...
          <div class="col-lg-12">
            <div class="panel panel-primary">
              ...
              <div class="panel-body">
                <form id="contact_form" action="<?php echo site_url('admin/admin_editdata') ?>" data-toggle="validator" role="form" method="post" enctype="multipart/form-data">
                  <div class="col-xs-6 col-md-6" style="margin-top:20px;">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="name_admin" id="name_admin" data-error="กรุณาระบุชื่อให้ถูกต้อง" required value="<?php echo $admin[0]['admin_name'] ?>">
                      <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group">
                      <label for="surname_admin"> นามสกุล : <span style="color:red; font-size:20px;">*</span> </label>
                      <input type="text" class="form-control" name="surname_admin" id="surname_admin" data-error="กรุณาระบนามสกุลให้ถูกต้อง" required value="<?php echo $admin[0]['admin_surname'] ?>">
                      <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group">
                      ...
                      <select class="form-control" name="gender_admin" id="gender_admin" data-error="กรุณาระบุเพศให้ถูกต้อง" required>
                        <option></option>
                        <option <?php if ($admin[0]['admin_gender'] == 'ผู้หญิง') { echo "selected"; } ?> value="ผู้หญิง">ผู้หญิง</option>
                        <option <?php if ($admin[0]['admin_gender'] == 'ผู้ชาย') { echo "selected"; } ?> value="ผู้ชาย">ผู้ชาย</option>
                      </select>
                      <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group">
                      <label for="birthday_admin">วันเกิด : <span style="color:red; font-size:20px;">*</span> </label>
                      <input type="date" class="form-control" name="birthday_admin" id="birthday_admin" data-error="กรุณาระบุวันเกิดให้ถูกต้อง" required value="<?php echo $admin[0]['admin_birthday'] ?>">
                      <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group">
                      <label for="tel_admin">เบอร์โทร : <span style="color:red; font-size:20px;">*</span> </label>
                      <input type="text" class="form-control" name="tel_admin" id="tel_admin" data-error="กรุณาระบุเบอร์โทรให้ถูกต้อง" required maxlength="10" value="<?php echo $admin[0]['admin_tel'] ?>">
                      <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group">
                      <label for="address_admin">ที่อยู่ : <span style="color:red; font-size:20px;">*</span> </label>
                      <textarea class="form-control" name="address_admin" id="address_admin" rows="5" data-error="กรุณาระบุที่อยู่ให้ถูกต้อง" required><?php echo $admin[0]['admin_address'] ?></textarea>
                      <div class="help-block with-errors"></div>
                    </div>
                  ...
                  <div class="col-xs-6 col-md-6" style="margin-top:20px;">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="idcard_admin" id="idcard_admin" maxlength="13" data-error="กรุณาระบุเลขบัตรประจำตัวประชาชนให้ถูกต้อง" required value="<?php echo $admin[0]['admin_idcard'] ?>">
                      <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group">
                      <label for="email_admin">อีเมล : <span style="color:red; font-size:20px;">*</span> </label>
                      <input type="email" class="form-control" name="email_admin" id="email_admin" data-error="กรุณาระบุอีเมลให้ถูกต้อง" required value="<?php echo $admin[0]['admin_email'] ?>">
                      <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group">
                      <label for="user_admin">ชื่อผู้ใช้งาน : <span style="color:red; font-size:20px;">*</span> </label>
                      <input type="text" class="form-control" name="user_admin" id="user_admin" data-error="กรุณาระบุชื่อผู้ใช้งานให้ถูกต้อง" required value="<?php echo $admin[0]['admin_user'] ?>">
                      <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group">
                      ...
                      <input type="hidden" class="form-control" name="id_admin" id="id_admin" value="<?php echo $admin[0]['admin_id'] ?>">
                    </div>
                    <div class="form-group">
                      <label for="file_admin">อัปโหลดรูปภาพ : <span style="color:red; font-size:20px;"> &nbsp;</span> </label>
                      <input type="file" class="form-control" name="file_admin" id="file_admin" data-error="กรุณาเลือกรูปภาพให้ถูกต้อง">
                      <div class="help-block with-errors"></div>
                    </div>
